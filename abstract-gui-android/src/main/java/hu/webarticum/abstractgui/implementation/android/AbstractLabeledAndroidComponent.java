...
public abstract class AbstractLabeledAndroidComponent extends AbstractAndroidComponent implements LabeledComponent {

    private Text text;


    protected AbstractLabeledAndroidComponent(AndroidEnvironment environment, Text text) {
        super(environment);
        this.text = text;
    }
